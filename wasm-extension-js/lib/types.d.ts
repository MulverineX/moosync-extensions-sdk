...
export type ProviderScope = "search" | "playlists" | "playlistSongs" | "artistSongs" | "albumSongs" | "recommendations" | "scrobbles" | "playlistFromUrl" | "songFromUrl" | "searchAlbum" | "searchArtist" | "playbackDetails";
...
export interface ExtensionAPI {
    ...
    on(event: "getPlaylistContent", cb: (id: string) => Promise<SongsWithPageTokenReturnType>): void;
    ...
    on(event: "getArtistSongs", cb: (artist: Artist) => Promise<SongsWithPageTokenReturnType>): void;
    on(event: "getAlbumSongs", cb: (album: Album) => Promise<SongsWithPageTokenReturnType>): void;
