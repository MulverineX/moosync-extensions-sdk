...
/**
 * Implementation of atob() according to the HTML and Infra specs.
 */
export function _atob(data: string) {
...
function atobLookup(chr) {
  ...
  // Return the index of the character in the lookup string
  return index;
}
